...
public class Memory extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("PGA memory");

        jButton2.setText("Apply");
        jButton2.setToolTipText("");

        jLabel3.setText("PGA memory allocated");

        jLabel6.setText("SGA memory allocated");

        jLabel8.setText("Total Memory");

        jLabel10.setText("jLabel10");

        jLabel9.setText("SGA memory");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(31, 31, 31)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(pga, javax.swing.GroupLayout.PREFERRED_SIZE, 109, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/maquette/Circuit-integre-vu-au-microscope.jpg"))); // NOI18N
        jLabel2.setText("jLabel2");

        jLabel7.setFont(new java.awt.Font("Times New Roman", 2, 36)); // NOI18N
        jLabel7.setText("Manage Memory");
...
new Acceuil().setVisible(true);
     ...
     */
    public void Updatemem() throws SQLException
    {
        try {
        ...
        Connection connection = DriverManager.getConnection(
					...
					"Hicham1992");
        if(connection==null) System.out.println("ghlatti");
      Statement st=connection.createStatement();
      ResultSet rs=st.executeQuery("select value from v$pgastat WHERE NAME='total PGA allocated'");
        while (rs.next()) {            
            jLabel4.setText(rs.getString(1));
        }
        String l = "MB";
      ResultSet rs2=st.executeQuery("select sum(bytes/1024/1024) MAX_SGA_SIZE_in_MB from v$sgainfo where name = 'Maximum SGA Size'");
        while (rs2.next()) {            
            jLabel5.setText(rs2.getString(1));
        }
      //ResultSet rs3=st.executeQuery("select sum(bytes/1024/1024) Current_SGA_SIZE_in_MB from v$sgastat");
                    
            jLabel10.setText(jLabel4.getText() + jLabel5.getText());
